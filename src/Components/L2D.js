const L2D = ({selectedStudent}) => {
  ...
  return (
    ...
    {selectedStudent.l2d &&<img className="w-full rounded-md" src={selectedStudent.l2d} alt="" />}
    {!selectedStudent.l2d && <h1>No L2D :(</h1>}
           </div>    
        </div>
        <div class="back p-4 rounded-md overflow-auto scrollbar-hide">
          <h1 className="px-2 text-2xl rounded-sm bg-black font-medium">Trivia</h1>
